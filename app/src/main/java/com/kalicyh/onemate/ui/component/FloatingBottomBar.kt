...
package com.kalicyh.onemate.ui.component
...
import com.kalicyh.onemate.ui.component.liquid.InnerShadow
import com.kalicyh.onemate.ui.component.liquid.innerShadow
import com.kalicyh.onemate.ui.component.liquid.lens
import com.kalicyh.onemate.ui.component.liquid.rememberCombinedBackdrop
import com.kalicyh.onemate.ui.component.liquid.vibrancy
import com.kalicyh.onemate.ui.component.miuix.animation.DampedDragAnimation
import com.kalicyh.onemate.ui.component.miuix.animation.InteractiveHighlight
import com.kalicyh.onemate.ui.theme.isInDarkTheme
...
fun FloatingBottomBar(
    ...
    var currentIndex by remember { mutableIntStateOf(selectedIndex.fastCoerceIn(0, tabsCount - 1)) }
    ...
    val dampedDragAnimation = remember(animationScope, tabsCount, density, isLtr) {
        DampedDragAnimation(
            ...
            initialValue = selectedIndex.fastCoerceIn(0, tabsCount - 1).toFloat(),
    ...
    LaunchedEffect(selectedIndex, tabsCount) {
        val targetIndex = selectedIndex.fastCoerceIn(0, tabsCount - 1)
